...
public class DeletarAlunos extends JFrame {
	...
	public DeletarAlunos(){
		...
		btnDeletar.addActionListener(new ActionListener(){
			...
			try {
				...
				AlunosJdbcDAO deletaralunosJdbcDao = new AlunosJdbcDAO(connection);
					
				deletaralunosJdbcDao.deletar(Integer.parseInt(id.getText()));
			}catch(Exception err) { 
				err.printStackTrace();
			}
	...
	public static void main(String args[]) {
		DeletarAlunos	 da = new DeletarAlunos();
	}
}
