...
public class DeletarProfessor extends JFrame {
	...
	public DeletarProfessor(){
		...
		btnDeletar.addActionListener(new ActionListener(){
			...
			try {
				...
				ProfessorJdbcDAO deletarprofessorJdbcDao = new ProfessorJdbcDAO(connection);
					
				deletarprofessorJdbcDao.deletar(Integer.parseInt(id.getText()));
			}catch(Exception err) { 
				err.printStackTrace();
			}
	...
	public static void main(String args[]) {
		DeletarProfessor dp = new DeletarProfessor();
	}
}
