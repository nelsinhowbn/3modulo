...
public class DeletarCordenador extends JFrame {
	JButton btnDeletar = new JButton("Deletar");
	JTextField id = new JTextField();
	JLabel deletarid = new JLabel("Digite o ID que será Deletado: ");
	
	public DeletarCordenador(){
		super("Apagar Cordenador");
		...
		btnDeletar.addActionListener(new ActionListener(){
			...
			try {
				...
				CordenadorJdbcDAO deletarcordenadorJdbcDao = new CordenadorJdbcDAO(connection);
					
				deletarcordenadorJdbcDao.deletar(Integer.parseInt(id.getText()));
			}catch(Exception err) { 
				err.printStackTrace();
			}
	...
	public static void main(String args[]) {
		DeletarCordenador dc = new DeletarCordenador();
	}
}
