...
protected static final String ToString = null;
...
public void alterar(Professor c, int id) {
	String sql = "update professor set nome='"+c.getNome()+"',endereco='"+c.getEndereco()+"',bairro='"+c.getBairro()+"' where id =" + id;
System.out.println(sql);
