...
public class AlterarCordenador extends JFrame {
	...
	public AlterarCordenador(){
		super("Alterar Cordenador");
		...
		btnSalvar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				cordenador.setId(Integer.parseInt( txtId.getText() ));
			...
			CordenadorJdbcDAO  cordenadorJdbcDao = new CordenadorJdbcDAO(connection);
			  ...
			  cordenadorJdbcDao.alterar(cordenador, cordenador.getId());
    ...
    {
    	AlterarCordenador ac = new AlterarCordenador();
    }
}
